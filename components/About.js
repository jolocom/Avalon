...
const About = ({ onClose }) => {
  return (
    <Overlay onClose={onClose}>
      ...
      <p className="big">
        This web experience is brought to you by{' '}
        <a href="https://jolocom.io">Jolocom</a>, to demonstrate how
        decentralized digital identity management can serve as a building block
        to revolutionize everyday interactions and activities.
      </p>
      <hr />
      ...
      <div className="Sections">
        <div>
          <p>
            ...
            organizations, and smart agents to own and control the identity that
            defines them.
            <br />
            <br />
            Our vision is for a future in which every entity capable of any type
            of identity is equally capable of communicating and sharing
        ...
        <div>
          <p>
            ...
            <br />
            <br />
            Want to learn how your sector can benefit from implementing
            Jolocom’s protocol?{' '}
            <a href="https://jolocom.io/solution/#conversation" target="_blank">
              Contact us
            </a>
            .
          </p>
